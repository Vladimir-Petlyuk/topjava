...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT u FROM Meal u WHERE  u.user.id=:user_id AND u.dateTime >=:start_date AND u.dateTime <=:end_date ORDER BY u.dateTime DESC"),
})
@Entity
